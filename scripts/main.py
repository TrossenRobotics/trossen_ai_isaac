...
def main(args):
    ...
    if box_pos[0] < 0:
        ...
        execute_pick_and_place(right_arm, box_pos[0], box_pos[1], box_yaw, left_arm_first=False)
        box_position, _ = box_prim.get_world_pose()
        # Left arm's end effector will rotate 90 degree, go and take box from the right arm
        handover_and_place(right_arm, left_arm, box_position, left_arm_first=False)
